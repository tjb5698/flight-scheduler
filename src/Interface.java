...
public class Interface extends javax.swing.JFrame implements ActionListener {
    ...
    private BookingQueries booking;
    
    public Interface() {
        initComponents();
        booking = new BookingQueries();
    ...
    @SuppressWarnings("unchecked")
     private void initComponents() {
        ...
        jLabel5.setText("FLY BY NIGHT FLIGHT REVERATION SYSTEM");
   ...
   public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == BookingFlightButton) {
        	Interface.this.BookingFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CheckStatusButton) {
            Interface.this.CheckStatusButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CheckWaitListButton) {
            Interface.this.CheckWaitListButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CancelFlightButton) {
            Interface.this.CancelFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == customerStatusCheckButton) {
            Interface.this.customerStatusCheckButtonActionPerformed(evt);
        }
        else if (evt.getSource() == MonthComboBox) {
            Interface.this.MonthComboBoxActionPerformed(evt);
        }
        else if (evt.getSource() == AddingDateButton) {
            Interface.this.AddingDateButtonActionPerformed(evt);
        }
        else if (evt.getSource() == newFlightButton) {
            Interface.this.newFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == droppingFlightButton) {
            Interface.this.droppingFlightButtonActionPerformed(evt);
        }
    }
    ...
    private void CheckWaitListButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(waitlist_comments.equals("")){
            ...
            Status_output_Bar.setText( "Waitlist for "+ date + ":\n" + waitlist_comments);
        }
    }
    ...
    private void CancelFlightButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelFlightButtonActionPerformed
        ...
        booking.waitListToBooked(flightID,date);
    ...
    private void droppingFlightButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(booking.ScheduledPassengers(flightID)){
        	...
        	booking.DeleteFlightSchedule(flightID);
            database.deleteFlight(flightID);
        }
        newFlightComboBox();
